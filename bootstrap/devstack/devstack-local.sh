...
glance image-create --name precise-server-cloudimg-amd64 --disk-format qcow2 --container-format bare --is-public true --progress --location http://cloud-images.ubuntu.com/precise/current/precise-server-cloudimg-amd64-disk1.img
